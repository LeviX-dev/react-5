...
|---|---|---|---|
${events.map(event => `| ${event.department} | ${event.emailTitle} | ${event.eventDate} | ${event.eventTime}    |`).join('\n')}
                    ...
                    <tbody>
                      {events.slice(0, 2).map((event, index) => (
                        <tr key={event.id} style={{ backgroundColor: index % 2 === 0 ? 'white' : '#fafafa' }}>
                          ...
                          <td style={{ padding: '8px', border: '1px solid #ddd' }}>{event.eventDate}</td>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <tbody>
                  ...
                  <tr style={{ borderBottom: '1px solid #eee' }}>
                    ...
                    <td style={{ padding: '12px 0' }}>{selectedEvent.eventDate}</td>
                  </tr>
                  <tr style={{ borderBottom: '1px solid #eee' }}>
